...
**Source spec:** `docs/superpowers/specs/2026-07-07-dogfood-findings-fixes-design.md`
...
**Files:**
- Modify: `docs/superpowers/dogfood-regression.md`（断言 #1 验证点列）
- Modify: `commands/review-loop.md`（第 4 节 `[已修]` 定义行）
- Modify: `docs/superpowers/2026-07-07-dogfood-findings.md`（frontmatter status → done）
- Modify: `docs/superpowers/specs/2026-07-07-dogfood-findings-fixes-design.md`（status → done）
- Modify: `docs/superpowers/plans/2026-07-07-dogfood-findings-fixes.md`（status → done，发版提交内）
...
```bash
git add docs/superpowers/dogfood-regression.md commands/review-loop.md docs/superpowers/2026-07-07-dogfood-findings.md docs/superpowers/specs/2026-07-07-dogfood-findings-fixes-design.md docs/superpowers/plans/2026-07-07-dogfood-findings-fixes.md
...
`.superpowers/sdd/progress.md` 追加本轮完成记录（任务清单、审查战果、defer 项）。
