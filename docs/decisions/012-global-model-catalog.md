...
本 ADR 只取代 ADR-011 中“公开接口发现 + unsupported/人工降级 + 启动时在线模型可用性复核”的部分；ADR-011 的 runner 绑定、难度分档、首次有效失败升级、CLI 优先级与可观测性继续生效。完整合同见 `docs/archive/specs/2026-07-22-global-model-catalog.md`。
