...
**Spec:** `docs/specs/2026-07-06-model-routing-design.md`
...
**Files:**
- Modify: `docs/specs/2026-07-06-model-routing-design.md`（status → done）
- Modify: `docs/plans/2026-07-06-model-routing.md`（status → done）
...
```bash
git add docs/specs/2026-07-06-model-routing-design.md docs/plans/2026-07-06-model-routing.md
