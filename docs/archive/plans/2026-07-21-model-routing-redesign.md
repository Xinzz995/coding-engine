...
**Spec:** `docs/specs/2026-07-21-model-routing-redesign.md`
...
- Update status after implementation: `docs/specs/2026-07-21-model-routing-redesign.md`
- Update status after implementation: `docs/plans/2026-07-21-model-routing-redesign.md`
...
- [ ] 运行 `git diff --check`，核对 `git status --short` 只包含本功能文件，不纳入用户已有 `.coding-x-local/` 等无关变更。
