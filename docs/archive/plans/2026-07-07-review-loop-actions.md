...
**Goal:** /review-loop 发现清单加动作三档（需人裁决/机械修/仅提示）、人审包落盘留痕与裁决回填（四态）、prd.tampered-* 红旗区——补「产物必人审」闭环的后半段（规格：`docs/specs/2026-07-07-review-loop-actions-design.md`）。
...
- Modify: `docs/specs/2026-07-07-review-loop-actions-design.md`（status: done）
...
`docs/specs/2026-07-07-review-loop-actions-design.md` frontmatter：`status: active` → `status: done`。

```bash
git add docs/specs/2026-07-07-review-loop-actions-design.md
