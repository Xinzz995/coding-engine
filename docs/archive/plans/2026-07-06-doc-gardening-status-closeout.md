...
**Spec:** `docs/specs/2026-07-06-doc-gardening-status-closeout-design.md`
...
- Modify: `docs/specs/` 下 8 份（见映射表；**不含** 2026-07-06 本轮 spec）
- Modify: `docs/plans/` 下 8 份（见映射表；**不含**本计划文件自身——它在本轮执行中保持 active，由发版后收口置 done）
...
Run: `grep -rn "^- 状态：" docs/specs/ | wc -l`
Expected: `0`

Run: `grep -rn "^status: active" docs/prds/ docs/specs/ docs/plans/ | wc -l`
...
```bash
git add docs/prds docs/specs docs/plans
...
**Files:**
- Modify: `docs/dogfood-regression.md`
- Modify: `README.md`
...
Run: `grep -c "状态变更清单" docs/dogfood-regression.md README.md commands/compound-docs.md`
...
```bash
git add docs/dogfood-regression.md README.md
...
```bash
git add docs/plans/2026-07-06-doc-gardening-status-closeout.md docs/specs/2026-07-06-doc-gardening-status-closeout-design.md
