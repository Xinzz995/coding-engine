...
日期：2026-07-07
来源：引擎真实跑 dogfood 轮发现清单 `docs/archive/dogfood/2026-07-07-dogfood-findings.md`（四机制首验 + Fable 5 代际实测轮检出）。全部为已被真实场景实证的缺陷/缺口，无假想需求。
...
| `docs/dogfood-regression.md` | 断言 #1 验证点校准 |
| `commands/review-loop.md` | 第 4 节 `[已修]` 补 AC 缺失类回流要求 |
| 测试（gate.test.ts / loop.test.ts 等既有位置） | 决策 6 的用例 |
| `docs/archive/dogfood/2026-07-07-dogfood-findings.md` | 交付后置 done |
