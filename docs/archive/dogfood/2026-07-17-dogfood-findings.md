...
<!-- 本轮 dogfood（0.17→0.21 五版首次真实跑：report.html / evidence 索引 / workspace 并发锁 + 12 断言全量复查）
     ...
     全程证据：.coding-x-local/sdd/progress.md 的 Dogfood ledger 段、engine-run-20260717{,-gate,-verify}.log、
     fixture .coding-x-local/fixtures/study-report-dogfood（分支 ralph/study-report-rerun-20260717，
