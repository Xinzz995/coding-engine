...
<!-- 本轮 dogfood（四机制首验 + Fable 5 代际实测）检出的引擎缺陷与流程缺口，供下一开发轮立项吸收。
     全程证据：.coding-x-local/sdd/progress.md 的 Dogfood ledger 段、engine-run-fable.log / engine-run-gate.log、
     fixture .coding-x-local/fixtures/study-report-dogfood（review 留痕 .workspace/review-2026-07-07.md、tampered 归档）。
     吸收完成后本文件置 done。 -->
